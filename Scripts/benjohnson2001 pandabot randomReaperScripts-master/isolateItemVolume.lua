...
function endUndoBlock()
	local actionDescription = "isolateItemVolume"
...
function addEnvelopePoints(trackEnvelope, startPosition, endPosition, noteLength)
	...
	reaper.InsertEnvelopePoint(trackEnvelope, endPosition-noteLength/4, centerValue, fastStartShape(), tension, selected, noSort)
	reaper.InsertEnvelopePoint(trackEnvelope, endPosition, minValue, linearShape(), tension, selected, noSort)
