...
function endUndoBlock()
	local actionDescription = "extendItemsForQuickAttack"
...
startUndoBlock()
	...
	for i = 0, numberOfSelectedItems - 1 do
		...
		if selectedItemPosition < noteLength then
			...
			reaper.SetMediaItemInfo_Value(selectedItem, "D_LENGTH", selectedItemLength + noteLength)
			...
			reaper.SetMediaItemInfo_Value(selectedItem, "D_FADEOUTLEN", noteLength/2)
		end
