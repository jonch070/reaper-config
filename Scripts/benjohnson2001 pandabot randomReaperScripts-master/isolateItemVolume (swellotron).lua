...
function addPoints(trackEnvelope)
	...
	reaper.InsertEnvelopePoint(trackEnvelope, endTime+1.0, centerValue, 4, 0, true, true)
	reaper.InsertEnvelopePoint(trackEnvelope, endTime+1.06, minValue, 0, 0, true, true)
