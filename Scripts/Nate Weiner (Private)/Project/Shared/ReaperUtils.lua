...
---@field startTime number Region start in project time (seconds)
---@field endTime number Region end in project time (seconds)
---@field index number Region index

---Gets all regions from a project
---@param proj ReaProject The project to enumerate regions from
---@return Region[] regions Array of region objects
function ReaperUtils.getAllRegions(proj)
    local regions = {}
    local numMarkers = reaper.CountProjectMarkers(proj)
