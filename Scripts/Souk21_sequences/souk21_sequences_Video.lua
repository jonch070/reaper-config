...
KEY 100 SHIFT false CMD false ALT false CTRL false NATIVE false ID _512e2cfd1b85473787a647eb354e7eba EXIT true HIDDEN false DISPLAY Dialogue Mute/Unmute
KEY 116 SHIFT false CMD false ALT false CTRL false NATIVE false ID _994a7cf488704ee5ae41d5e1b12df597 EXIT true HIDDEN false DISPLAY Temp Solo/UnSolo
]]
...
local actions = {
    {
        hidden = false,
        display_name = "Dialogue Mute/Unmute",
        command_exists = true,
        alt = false,
        ctrl = false,
        exit = true,
        key = 100,
        shift = false,
        action = "_512e2cfd1b85473787a647eb354e7eba",
        native = false,
        action_text = "Custom: Mute/Unmute Dialogue",
        cmd = false,
        key_text = "d",
    },
    {
        hidden = false,
        display_name = "Temp Solo/UnSolo",
        command_exists = true,
        alt = false,
        ctrl = false,
        exit = true,
        key = 116,
        shift = false,
        action = "_994a7cf488704ee5ae41d5e1b12df597",
        native = false,
        action_text = "Custom: Solo/UnSolo Temp",
        cmd = false,
        key_text = "t",
    },
}
...
function main()
    ...
    local char, command, exit, hwnd, unmatched = UI(actions, style, shown, "KeySequenceListenerVideo")
