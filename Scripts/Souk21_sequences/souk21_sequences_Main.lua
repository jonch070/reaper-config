...
KEY 116 SHIFT false CMD false ALT false CTRL false NATIVE false ID _RS1ecf79bc87f56308b483366c7124c4293f3696b2 EXIT true HIDDEN false DISPLAY Toolbars
KEY 118 SHIFT false CMD false ALT false CTRL false NATIVE false ID _RSe07a82166ca33f41e6e52e22d1ded71f70d1c571 EXIT true HIDDEN false DISPLAY Video
]]
...
local actions = {
    {
        shift = false,
        exit = true,
        action_text = "Script: souk21_sequences_Toolbars.lua",
        hidden = false,
        cmd = false,
        action = "_RS1ecf79bc87f56308b483366c7124c4293f3696b2",
        ctrl = false,
        key_text = "t",
        alt = false,
        command_exists = true,
        display_name = "Toolbars",
        native = false,
        key = 116,
    },
    {
        shift = false,
        exit = true,
        action_text = "Script: souk21_sequences_Video.lua",
        hidden = false,
        cmd = false,
        action = "_RSe07a82166ca33f41e6e52e22d1ded71f70d1c571",
        ctrl = false,
        key_text = "v",
        alt = false,
        command_exists = true,
...
function main()
    ...
    local char, command, exit, hwnd, unmatched = UI(actions, style, shown, "KeySequenceListenerMain")
