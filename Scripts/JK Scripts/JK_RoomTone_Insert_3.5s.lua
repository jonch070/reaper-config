-- JK_RoomTone_Insert_3.5s.lua
-- Inserts "Clean silence_3.5 Seconds.mp3" at the current edit cursor
...
--
-- Suggested use: Tail fix (end-of-chapter / end-of-book tail silence)
-- Macro:  JK_RoomTone_DetectAndDelete → JK_RoomTone_Insert_3.5s → JK_RoomTone_AdvanceMarker
--
...
local ROOM_TONE_FILE = "Clean silence_3.5 Seconds"   -- extension resolved automatically
