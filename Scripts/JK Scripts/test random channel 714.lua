-- ReaScript Name: Assign Random Output Channel to All Selected Tracks (excluding 4) and Set 12 Output Channels
-- Author: ChatGPT
-- Version: 1.3
...
for i = 0, num_tracks - 1 do
  ...
  -- Set the track to use 12 output channels
  ...
  -- Generate a random output channel between 1 and 12, excluding 4
  local output_channel
  repeat
    output_channel = math.random(1, 12)
