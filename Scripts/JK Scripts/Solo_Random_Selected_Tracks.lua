-- Solo Random Selected Tracks
-- Solos a random number of tracks from the current selection.
-- Options: specify how many tracks to solo (or "random"), skip muted tracks.

-- Prompt user for settings
local ret, csv = reaper.GetUserInputs(
  "Solo Random Selected Tracks", 2,
...
-- Build list of eligible tracks from selection only
...
reaper.Undo_EndBlock("Solo " .. solo_count .. " random selected tracks", -1)
