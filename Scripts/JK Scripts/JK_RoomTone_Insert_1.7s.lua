-- JK_RoomTone_Insert_1.7s.lua
-- Inserts "Clean silence_1.7 Seconds.mp3" at the current edit cursor
...
local ROOM_TONE_FILE = "Clean silence_1.7 Seconds"   -- extension resolved automatically
