...
if sws then
    ...
    wrap_unwrap_dll = script_path..[[Data]]..separator..bin..separator..[[lkc_renderblocks_pack_unpack.dll]]
    dofile(script_path..[[Data]]..separator..bin..separator..[[lkc_renderblocks_pack_clusters.dll]])
else
